...
final List<String> offlineUrls = [
  ...
  './.build.manifest',
  './.packages',
  './assets/app-icons/icon-128x128.png',
  './assets/app-icons/icon-144x144.png',
  './assets/app-icons/icon-152x152.png',
  './assets/app-icons/icon-192x192.png',
  './assets/app-icons/icon-384x384.png',
  './assets/app-icons/icon-512x512.png',
  './assets/app-icons/icon-72x72.png',
  './assets/app-icons/icon-96x96.png',
  ...
  './assets/buttons/left-arrow.png',
  './assets/buttons/okay.png',
  './assets/buttons/player-dialog.png',
  './assets/buttons/right-arrow.png',
  './assets/buttons/settings.png',
  './assets/buttons/sound-off.png',
  './assets/buttons/sound-on.png',
  './assets/buttons/sound-pause.png',
  './assets/buttons/sound-play.png',
  './assets/buttons/start.png',
  './assets/characters/assassin.png',
  './assets/characters/loyal-servant.png',
  './assets/characters/merlin.png',
  './assets/characters/minion.png',
  './assets/characters/mordred.png',
  './assets/characters/morgana.png',
  './assets/characters/oberon.png',
  './assets/characters/percival.png',
  './assets/settings-icons/cathy-icon.png',
  './assets/settings-icons/duck.png',
  './assets/settings-icons/en-gb-C-icon.png',
  ...
  './packages/angular_components/material_input/material_auto_suggest_input.md',
  './packages/angular_components/material_select/material_dropdown_select.md',
  './packages/angular_components/src/material_datepicker/closedhand.cur',
  './packages/angular_components/src/material_datepicker/openhand.cur',
...
final String lastModified = '2019-11-16T17:50:03.000Z';
